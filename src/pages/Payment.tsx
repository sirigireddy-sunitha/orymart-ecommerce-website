            ...
            <Card>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Payment Information */}
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg">{t('payment.paymentInfo', 'Payment Information')}</h3>
                    <div>
                    ...
                    <div>
                      <Label htmlFor="nameOnCard">{t('payment.nameOnCard', 'Name on Card')}</Label>
                      <Input
                        id="nameOnCard"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="expiryDate">{t('payment.expiryDate', 'Expiry Date')}</Label>
                        <Input
                          id="expiryDate"
                          placeholder="MM/YY"
